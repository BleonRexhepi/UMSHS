						...
						<table>
							...
							<?php
								if (!empty($_REQUEST['term'])) {
									...
									$sql= mysqli_query ($lidhe2, "CALL umshs_zgjedhterm_perdoruesin('$term')");  
									while($rreshti = mysqli_fetch_array($sql)) { 		
										echo "<tr>";
											echo "<td>".$rreshti['Emri']."</td>";
											echo "<td>".$rreshti['Fjalekalimi']."</td>";
											echo "<td>".$rreshti['Email']."</td>";
											echo "<td><a href=\"modifiko_perdorues.php?ID_Perdoruesi=$rreshti[ID_Perdoruesi]\" class='button primary'>Modifiko</a></td>
										</tr>";													
									}
								}
							?>					
