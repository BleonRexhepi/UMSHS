				...
				<section id="second" class="main special">					
					...
					<div class="table-wrapper">
						<table>
							<thead>
								<tr>
									<th style="text-align:center;">Shenimi</th>
									<th style="text-align:center;">Pershkrimi</th>
									<th style="text-align:center;">Fajlli</th>
							...
							<?php
								if (!empty($_REQUEST['term'])) {
									...
									($lidhe,$_REQUEST['term']); 
									$sql= mysqli_query ($lidhe7, "CALL umshs_zgjedhterm_tedhena('$term')"); 
